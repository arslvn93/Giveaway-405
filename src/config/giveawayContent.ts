...
export const prizeContent = {
  title: "Win a $100 Gift Card at Your Local Barber Shop!",
  description:
    "Treat your family to a fresh, stylish look with our exclusive giveaway. Enjoy a $100 gift card to a local barber shop—perfect for a fun family day out!",
  features: [
    "Enjoy stylish haircuts for the entire family",
    "Support your local favorite barber shop",
    "Limited time offer: from March 19, 2025 to April 7, 2025",
    "Simple entry process with multiple chances",
...
export const headerContent = {
  title: "Win a $100 Gift Card at Your Local Barber Shop!",
  description:
    "Treat your family to a fresh, stylish look. Enter for a chance to win a $100 gift card from our featured local barber shop. No purchase necessary—hurry, this exclusive offer ends soon!",
  ctaText: "Enter Now",
...
export const howToEnterContent = {
  title: "How to Enter",
  description:
    "Getting started is easy! Follow these simple steps to enter our exciting giveaway and secure your chance to win a $100 gift card to a local barber shop.",
  steps: [
    {
      icon: "Mail",
  ...
  rules: [
    {
      ...
      answer:
        "Anyone 18 years or older residing in the eligible area can enter this giveaway."
    },
    {
      question: "How long does the giveaway run?",
      answer:
        "This giveaway is open from March 19, 2025 until April 7, 2025, as indicated by the countdown timer."
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, we take privacy seriously. Your information will be used only for this giveaway and will not be shared with third parties."
    }
  ],
  imageUrl:
...
export const footerContent = {
  aboutText:
    "The Sky Group specializes in offering exclusive giveaways and connecting our community with the best local businesses.",
  email: "info@theskygroup.ca",
  phone: "289-210-5250",
